      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute bottom-16 sm:bottom-18 right-0 w-[calc(100vw-2rem)] sm:w-72 max-w-[280px] bg-white rounded-2xl shadow-[0_12px_40px_rgba(0,0,0,0.12)] overflow-hidden"
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-pink-hot to-pink-light px-5 py-4">
              <h3 className="heading-md text-lg text-cream">
                Hey there! 👋
              </h3>
            ...
            <div className="p-3 space-y-1">
              {quickReplies.map((reply) => (
                <Link
                  ...
                  className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl hover:bg-pink-light/20 transition-colors duration-200 group"
                >
                  ...
                  <svg
                    className="w-3.5 h-3.5 text-warm-gray group-hover:text-pink-hot transition-colors"
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
